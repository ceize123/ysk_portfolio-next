...
function Resume() { 
	...
	return (
		<div className={`resume-page md:p-10 p-5 flex justify-center ${!loaded ? "overflow-hidden h-screen opacity-0" : "opacity-100 z-50 md:mt-14 mt-12"}`} onLoad={() => setLoaded(true)}>
